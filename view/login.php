            ...
            <div class="user_card">
                <div class="d-flex justify-content-center">
                    <div class="brand_logo_container">
                        <img src="../webroot/image/logo/logo1.png" class="brand_logo" alt="Logo">
                    </div>
                </div>
                ...
                <div class="mt-4">
                    ...
                    <div class="d-flex justify-content-center links">
                        <a href="../?view=forget-pass" class="text-decoration-none ml-2 ">Quên mật khẩu</a>
                    </div>
                    <div class="d-flex justify-content-center links">
                        <a href="../admin/login.php" class="text-decoration-none ml-2 ">Đăng nhập admin</a>
                    </div>
                </div>
            </div>
        </div>
