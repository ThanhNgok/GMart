...
<head>
    <title>THỰC PHẨM - SẠCH - TƯƠI SỐNG - CHẤT LƯỢNG</title>
    <meta charset="utf-8">
                        ...
                        <div class="col-sm-8 offset-sm-2 text-center">
                            <div class="row">
                                <div class="owl-carousel2">
                                    <div class="item">
                                        <div class="col">
                                            <h3><a href="#">Giảm giá 25% (1/1 - 15/1/2024) cho tất cả các sản phẩm</a>
                                            </h3>
                                        </div>
                                    </div>
                                    <div class="item">
                                    ...
                                    <div class="item">
                                        <div class="col">
                                            <h3><a href="#">Giảm 20% khi đến mua tại cửa hàng trong tháng 1
                                                </a></h3>
                                        </div>
                                    </div>
                                </div>
