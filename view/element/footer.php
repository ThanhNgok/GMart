        ...
        <div class="row row-pb-md">
            <div class="col-5 footer-col colorlib-widget ">
                <div class="d-flex justify-content-center align-items-center ">
                    <div id="colorlib-logo">
                        <a href="?view">
                            <img class="logo-header custom-circle rounded-circle" src="webroot/image/logo/logo1.png" alt="">
                        </a>
                    </div>
                </div>
                <br>
                <h5 class="text-white">Gmart - Thực phẩm tươi sạch </h5>
                <p class="text-white">
                    56 Hoàng Diệu 2, Thủ Đức, Thành phố Hồ Chí Minh</p>
            </div>
            ...
            <div class="col-3 footer-col colorlib-widget">
                ...
                <ul class="colorlib-footer-links">
                    ...
                    <li><a href="#" class="text-white">Shopee</a></li>
                </ul>
                </p>
            </div>
        </div>
            ...
            <div class="col-sm-12 text-center">
                <p>
                    <span class="text-white">
                        ...
                        </script> All rights reserved | Gmart-group
                    </span>
                </p>
            </div>
        </div>
