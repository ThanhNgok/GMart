...
<div class="container-fluid">
    <div class=" alert alert-primary">
        <h4 class="page-title">
            ...
            </span> ADMIN &#160;<i class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; Doanh Thu
        </h4>
    </div><br>
    <div class="row">
                ...
                <div class="card-body">
                    ...
                    <table class="m-auto ">
                        <thead>
                            <tr>
                                <th>Tổng Tiền : </th>
                                <th class="text-danger font-weight-bold"> <?php echo '&#160;' . number_format($tt) . ' đ <br>' ?>
                                </th>
                            </tr>
                            <tr>
                    ...
                    <h6 class="text-right"><a href="index.php?action=danhthu&view=ctdt&thang=<?php echo $month; ?>&nam=<?php echo $nam2 ?>">Xem
                            chi tiết</a></h6>
                </div>
            </div>
            <br>
    ...
    if (isset($_POST['xem2'])) {
        ...
        <div class="card">
            <div class="card-body">
                ...
                <h6 class="text-right"><a href="index.php?action=danhthu&view=ctdt&tu=<?php echo $tu; ?>&den=<?php echo $den ?>">Xem chi
                        tiết</a></h6>
            </div>
        </div>
