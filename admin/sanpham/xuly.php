...
if (isset($_POST['xlthem'])) {
	...
	$sql_them = " INSERT INTO `sanpham`(`MaSP`, `TenSP`, `MaDM`, `MaNCC`, `MoTa`, `DonGia`,`SoLuong`, `AnhNen`) VALUES (NULL,'$tensp',$madm,$mancc,'$mota',$dongia,'$soluong','$anhnen')";
	...
	if (isset($rs_them)) {
		...
		if (isset($qk)) {
			(int) $so = $qk['MaSP'];
			$dem = 1;
			$sql_addanhsp = "INSERT INTO anhsp (MaSP, Anh1, Anh2, Anh3, Anh4) VALUES ('$so', '$anhnen', '$anhnen', '$anhnen', '$anhnen')";
			echo $sql_addanhsp;
