                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_array($rs)) { ?>
                        <tr>
                            ...
                            <td>
                                <a style="color: blue;" href="index.php?action=nhanvien&view=sua&manv=<?php echo $row['MaNV']; ?>">Sửa</a>
                            </td>
                            <td><a style="color: red;" href="nhanvien/xuly.php?xoa&manv=<?php echo $row['MaNV']; ?>">Xóa</a></td>
                        </tr>
                    <?php    } ?>
                </tbody>
            </table>
