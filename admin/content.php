...
$nam = $date['year'];
$sql_dtt = "SELECT * FROM hoadon WHERE TinhTrang='hoàn thành' and (NgayGiao BETWEEN '" . $thang . "-00' AND'" . $thang . "-30')";
...
$sql_dtn = "SELECT * FROM hoadon WHERE TinhTrang='hoàn thành' and NgayGiao LIKE '" . $nam . "-%-%'";
$rsn = mysqli_query($conn, $sql_dtn);
$danhthunam = 0;

while ($rown = mysqli_fetch_array($rsn)) {
  $danhthunam += $rown['TongTien'];
}
?>
            ...
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                <font style="vertical-align: inherit;">
                  <font style="vertical-align: inherit;">Doanh Thu (Tháng)</font>
                </font>
              </div>
              <div class="h5 mb-0 font-weight-bold text-gray-800">
                <font style="vertical-align: inherit;">
                  <font style="vertical-align: inherit;"><?php echo number_format($danhthuthang) . ' đ' ?></font>
                </font>
              </div>
            </div>
            <div class="col-auto">
          ...
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                <font style="vertical-align: inherit;">
                  <font style="vertical-align: inherit;">Doanh Thu (Năm)</font>
                </font>
              </div>
              <div class="h5 mb-0 font-weight-bold text-gray-800">
                <font style="vertical-align: inherit;">
                  <font style="vertical-align: inherit;"><?php echo number_format($danhthunam) . ' đ' ?></font>
                </font>
              </div>
            </div>
            <div class="col-auto">
          ...
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                <font style="vertical-align: inherit;">
                  <font style="vertical-align: inherit;">Lợi Nhuận</font>
                </font>
              </div>
              <div class="row no-gutters align-items-center">
                <div class="col-auto">
                  <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                    <font style="vertical-align: inherit;">
                      <font style="vertical-align: inherit;">Loading...</font>
                    </font>
                  </div>
                </div>
                <!-- <div class="col">
      ...
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary">
            <font style="vertical-align: inherit;">
              <font style="vertical-align: inherit;">Quản Lý Hệ Thống</font>
            </font>
          </h6>
        </div>
        <div class="card-body">
