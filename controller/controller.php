...
if (isset($_GET['view'])) {
    ...
    switch ($view) {
        ...
        case 'sign-up':
            ...
            break;
        case 'forget-pass':
            include('view/forget-pass.php');
            break;
        case 'forget_pass':
            include('view/forget-pass.php');
            $name = $_POST['name'];
            $forget = forget_pass($name);
            if ($forget) {
                while ($row = mysqli_fetch_assoc($forget)) {
                    ...
                    try {
                        ...
                        $mail->Username   = 'thanhngoc1709a@gmail.com';                     //SMTP username
                        $mail->Password   = 'lebj wkux cvyx ljer';                               //SMTP password
                        $mail->setFrom('thanhngoc1709a@gmail.com', 'Ngọc');
                        $mail->addAddress($name);
                        $mail->Subject = 'CẤP LẠI MẬT KHẨU GMART';
                        $mail->Body = 'Mật khẩu Gmart của bạn là: ' . $row['MatKhau'];
                        $mail->CharSet = 'utf8';
                        $mail->send();
                        return true;
                        header('location:view/login.php');
