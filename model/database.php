...
function order_product($nn, $dcnn, $sdtnn, $makh, $tt)
{
  ...
  if ($resulf) {
    ...
    foreach ($_SESSION['cart_product'] as $item) {
      ...
      $mamau = $item['Mau'];
      $size = $item['Size'];
      $sql3 = "INSERT INTO `chitiethoadon`(`MaHD`, `MaSP`, `SoLuong`, `DonGia`, `ThanhTien`, `Size`, `MaMau`) VALUES($mahd,$masp,$sl,$dg,$ttt,42,'None')";
      var_dump($sql3);
